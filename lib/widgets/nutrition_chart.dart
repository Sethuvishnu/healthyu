  ...
  Widget build(BuildContext context) {
    return Container(
      decoration: BoxDecoration(
        // FIX: was a near-black color (19,18,18), which made all the
        // dark text on top of it unreadable. Card background is now
        // white so it matches the rest of the app's light theme.
        color: Colors.white,
                      ...
                      children: [
                        ...
                        Text(
                          ...
                          style: TextStyle(
                            fontSize: 15,
                            height: 1.4,
                            // FIX: was near-black text hardcoded — worked only
                            // by accident against the old dark card. Now uses
                            // the theme's secondary text color so it stays
                            // readable and consistent with the rest of the app.
                            color: AppTheme.textSecondary,
                          ),
                        ),
                      ],
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Expanded(
                            child: Text(
                              tip,
                              // FIX: this text had no explicit color before,
                              // which meant it inherited whatever the
                              // surrounding theme's default text color was —
                              // now it's pinned to textPrimary so it's always
                              // legible regardless of theme context.
                              style: const TextStyle(
                                fontSize: 15,
                                height: 1.4,
                                color: AppTheme.textPrimary,
